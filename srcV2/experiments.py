...
import srcV2.data_utils as data_utils
import srcV2.eval
from srcV2.knowledge_graph import KnowledgeGraph
from srcV2.rl.graph_search.pn import GraphSearchPolicy
from srcV2.rl.graph_search.pg import PolicyGradient
from src.utils.ops import flatten
from srcV2.config import config
import logging
import time
...
def inference(lf):
    ...
    for i in range(1, args.batch_num):
        ...
        # if args.vs100:
        #     hits_1_, hits_3_, hits_5_, hits_10_, mrr_ = srcV2.eval.hits_and_ranks_vs100(test_data__, test_scores,
        #                                                                                lf.kg.all_objects,
        #                                                                                corrupts[i],
        #                                                                                verbose=True)
        # else:
        ...
        hits_1_, hits_3_, hits_5_, hits_10_, mrr_ = srcV2.eval.hits_and_ranks(test_data__, test_scores,
