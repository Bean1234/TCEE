def config(args):
    ...
    if 'FB' in args.data_dir:
        ...
        args.grad_norm = 0
        args.emb_dropout_rate = 0.3 #ori 0.5
        args.ff_dropout_rate = 0.3
        args.action_dropout_rate = 0.5
        args.beta = 0
        args.beam_size = 128
        # ARGCN
        args.neigh_dropout = 0.5 #ori 0.7
        args.node_dropout = 0.5 #ori 0.7
        # Augmentation Link
        args.aug_link_threshold = 0.35 #ori 0.3
        args.aug_link_support_threshold = 1.0
